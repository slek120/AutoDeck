...
# Decks are in the form [j_1, j_2,..., j_n] where j_i is True or False
# If j_i is True, collection[i] is used in the deck
decks = [[False for j in range(len(collection))] for i in range(maxCost+1)]
